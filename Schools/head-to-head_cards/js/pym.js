    ...
    lib.Child = function(config) {
        ...
        this.sendHeight = function() {
            // Get the child's height.
             ...
             var grid = document.getElementsByClassName('grid')[0].offsetHeight

             var grid2 = document.getElementsByClassName('grid2')[0].offsetHeight
            ...
            var height = grid > grid2 ? intro + intro + grid : intro + intro + grid2
